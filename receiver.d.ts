 ...
 */
export type InferProtocolServerRequest<P extends string> = P extends keyof ProtocolServerRequestMap ? ProtocolServerRequestMap[P] : unknown;
/**
 ...
 */
export type InferProtocolServerResponse<P extends string> = P extends keyof ProtocolServerResponseMap ? ProtocolServerResponseMap[P] : unknown;
 ...
 */
export interface HyperServerListenOptions<P extends SenderProtocol = SenderProtocol, TRequest = InferProtocolServerRequest<P>, TResponse = InferProtocolServerResponse<P>> {
    /**
...
export type AnyHyperReceiver<P extends SenderProtocol = SenderProtocol> = HyperReceiver<any, any, any, any, P>;
/**
