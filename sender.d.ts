 ...
 */
export type InferProtocolInput<P extends string> = P extends keyof ProtocolInputMap ? ProtocolInputMap[P] : unknown;
/**
 ...
 * @template P - The protocol identifier.
 */
export type InferProtocolMetadata<P extends string> = P extends keyof ProtocolMetadataMap ? ProtocolMetadataMap[P] : Record<string, unknown>;
/**
 ...
 * @template P - The protocol identifier.
 */
export interface HyperSender<TInput = unknown, TOutput = unknown, TPrepared = unknown, TRaw = unknown, P extends SenderProtocol = SenderProtocol> {
    /**
     ...
     */
    parse(raw: TRaw, ctx: RequestContext): UniversalResponse<TOutput> | Promise<UniversalResponse<TOutput>>;
}
export type AnyHyperSender<P extends SenderProtocol = SenderProtocol> = HyperSender<any, any, any, any, P>;
/**
